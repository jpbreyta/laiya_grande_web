        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                            ...
                            <div class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">₱{{ number_format($booking->total_price, 2) }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                        ...
                        <span class="inline-flex items-center px-4 py-2 rounded-full text-xs font-bold shadow-sm
                            ...
                            <span class="w-2 h-2 rounded-full mr-2 {{ $booking->status === 'confirmed' ? 'bg-green-500' : ($booking->status === 'pending' ? 'bg-amber-500' : 'bg-red-500') }}"></span>
                        {{ ucfirst($booking->status) }}
                    </span>
                </div>
            </div>
            ...
            @endif
                ...
                @endif
                    ...
                    <a href="{{ route('admin.booking.index') }}" class="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white px-6 py-2.5 rounded-lg font-medium shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200">
                        Back to List
                    </a>
                </div>
            </div>
