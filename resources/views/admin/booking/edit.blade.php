                ...
                <form action="{{ route('admin.booking.update', $booking->id) }}" method="POST">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div class="space-y-4">
                                <div
                                    ...
                                    <label class="text-xs font-bold text-blue-600 uppercase tracking-wider mb-1 block">Guest
                                        Name</label>
                                ...
                                <div
                                    ...
                                    <label
                                        class="text-xs font-bold text-gray-600 uppercase tracking-wider mb-1 block">Email</label>
                                ...
                                <div
                                    class="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                                    <label class="text-xs font-bold text-gray-600 uppercase tracking-wider mb-1 block">Phone
                                        Number</label>
                                ...
                                <div
                                    class="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                                    <label
                                        class="text-xs font-bold text-gray-600 uppercase tracking-wider mb-1 block">Number
                                        of Guests</label>
                            ...
                            <div class="space-y-4">
                                <div
                                    class="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100">
                                    <label
                                ...
                                <div
                                    class="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                                    <label
                                        class="text-xs font-bold text-gray-600 uppercase tracking-wider mb-1 block">Check-in
                                        Date</label>
                                ...
                                <div
                                    class="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                                    <label
                                        class="text-xs font-bold text-gray-600 uppercase tracking-wider mb-1 block">Check-out
                                        Date</label>
                                ...
                                <div
                                    ...
                                    <label
                                        class="text-xs font-bold text-green-600 uppercase tracking-wider mb-1 block">Total
                                        Price</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div class="p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg border border-gray-200">
                                <label
                                    class="text-xs font-bold text-gray-600 uppercase tracking-wider mb-2 block">Status</label>
                                <select name="status"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                        ...
                        @if ($booking->payment && file_exists(storage_path('app/public/' . $booking->payment)))
                            <div
                                ...
                                <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider mb-3">Payment Proof
                                </h3>
