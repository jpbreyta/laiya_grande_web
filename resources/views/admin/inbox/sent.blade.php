...
<div class="poppins min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 px-6 py-10">
    <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6 mb-8 flex items-center justify-between">
        <h1 class="text-3xl font-semibold text-gray-900 tracking-tight">📤 Sent Messages</h1>
        <div class="flex gap-3 items-center text-gray-600">
            ...
            <button onclick="deleteSelected()" class="p-2 rounded-full hover:bg-gray-100 transition" title="Delete Selected">
            ...
            <ul class="divide-y divide-gray-100">
                @foreach ($messages as $message)
                    <li class="mail-item group p-5 flex items-start gap-4 rounded-lg transition hover:bg-gray-50">
                        <input type="checkbox" class="mt-2 message-checkbox rounded border-gray-300 focus:ring-0" value="{{ $message->id }}" />
                        ...
                        <div class="flex-1 cursor-pointer" onclick="window.location.href='{{ route('admin.inbox.show', $message->id) }}'">
                            ...
                            <span class="inline-block px-2 py-1 bg-green-100 text-green-800 text-xs rounded-full mt-2">Replied</span>
                        </div>
                    </li>
                @endforeach
            </ul>
