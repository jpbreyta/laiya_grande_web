    ...
    <section class="py-8 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex flex-wrap justify-center gap-4">
                <button
                    class="gallery-filter active bg-teal-500 text-white px-6 py-2 rounded-full font-medium transition-all duration-300 hover:bg-teal-600"
                    data-filter="all">
                    ALL
                </button>
                <button
                    class="gallery-filter bg-white text-gray-700 px-6 py-2 rounded-full font-medium transition-all duration-300 hover:bg-teal-50"
                    data-filter="beach">
                    BEACH
                </button>
                <button
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="gallery-grid">
                ...
                <div class="gallery-item beach group cursor-pointer" data-category="beach">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-teal-100 to-cyan-100 flex items-center justify-center">
                            <img src="{{ asset('images/beach1.jpg') }}" alt="Pristine Beach"
                ...
                <div class="gallery-item beach group cursor-pointer" data-category="beach">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-yellow-100 to-orange-100 flex items-center justify-center">
                            <img src="{{ asset('images/sunset1.jpg') }}" alt="Sunset Views"
                                class="w-full h-full object-cover"
                                onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                            <div class="text-center hidden">
                ...
                <div class="gallery-item beach group cursor-pointer" data-category="beach">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center">
                ...
                <div class="gallery-item rooms group cursor-pointer" data-category="rooms">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item rooms group cursor-pointer" data-category="rooms">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item rooms group cursor-pointer" data-category="rooms">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-indigo-100 to-blue-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item amenities group cursor-pointer" data-category="amenities">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-red-100 to-pink-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item amenities group cursor-pointer" data-category="amenities">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-yellow-100 to-amber-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item activities group cursor-pointer" data-category="activities">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-orange-100 to-red-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item activities group cursor-pointer" data-category="activities">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-green-100 to-teal-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item activities group cursor-pointer" data-category="activities">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-purple-100 to-indigo-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item beach group cursor-pointer" data-category="beach">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-cyan-100 to-blue-100 flex items-center justify-center">
                            <div class="text-center">
                ...
                <div class="gallery-item beach group cursor-pointer" data-category="beach">
                    <div
                        class="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                        <div
                            class="aspect-square bg-gradient-to-br from-emerald-100 to-teal-100 flex items-center justify-center">
                            <div class="text-center">
    ...
    <div id="lightbox" class="fixed inset-0 bg-black/90 z-50 hidden flex items-center justify-center p-4">
        <div class="relative max-w-6xl max-h-full">
            <button id="close-lightbox"
                class="absolute -top-12 right-0 text-white text-2xl hover:text-gray-300 transition-colors z-10">
                ✕
            </button>
                ...
                <div class="aspect-video relative">
                    ...
                    <div class="absolute inset-0 bg-black/20 flex items-center justify-center">
                        <div class="text-center text-white">
                            ...
                            <p id="lightbox-description" class="text-lg">Experience the pristine beauty of Laiya Grande
                            </p>
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            galleryItems.forEach(item => {
                item.addEventListener('click', function() {
                    ...
                    if (lightboxTitle && photoTitleEl) lightboxTitle.textContent = photoTitleEl
                        .textContent;
                    if (lightboxDescription && photoDescriptionEl) lightboxDescription.textContent =
                        photoDescriptionEl.textContent;
