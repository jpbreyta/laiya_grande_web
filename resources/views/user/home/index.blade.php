...
@section('content')
            ...
            <div class="relative mx-auto max-w-7xl px-6 py-24 flex min-h-[80svh] items-center justify-center">
                <div class="text-center text-white max-w-4xl">
                    ...
                    <p class="text-lg text-white/80 mb-10 max-w-2xl mx-auto animate-fade-in" style="animation-delay: 0.6s;">
                        Experience paradise with pristine beaches, luxury accommodations, and world-class amenities in the
                        heart
                        of Batangas.
                    </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <ul class="space-y-3 mb-6">
                        ...
                        <li class="flex items-start gap-3">
                            <div class="w-2 h-2 bg-teal-500 rounded-full mt-2 flex-shrink-0"></div>
                            <p class="text-lg text-gray-600">Laiya Grande offers comfort, luxury, and an unforgettable stay
                ...
                <div class="bg-gradient-to-br from-teal-100 to-cyan-100 rounded-2xl p-8 text-center">
                    <img src="{{ asset('images/laiyagrande-logo.png') }}" alt="Laiya Grande Beach Resort"
                        class="h-56 w-auto mx-auto mb-8">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div
                    class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-6 border-2 border-yellow-200 hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex flex-col">
                    <div class="text-center flex-1 flex flex-col">
                        ...
                        <button
                            class="w-full bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 mt-auto">
                            Book Now
                        </button>
                    </div>
                </div>
                ...
                <div
                    class="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6 border-2 border-teal-200 hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex flex-col">
                    <div class="text-center flex-1 flex flex-col">
                        ...
                        <button
                            class="w-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 mt-auto">
                            Book Now
                        </button>
                    </div>
                </div>
                ...
                <div
                    class="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-6 border-2 border-pink-200 hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex flex-col">
                    <div class="text-center flex-1 flex flex-col">
                        ...
                        <button
                            class="w-full bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 mt-auto">
                            Book Now
                        </button>
                    </div>
                </div>
    ...
    <section class="py-16 bg-gradient-to-br from-teal-600 to-teal-700 text-white">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <p class="text-lg text-white/90 mb-8">Book your stay at Laiya Grande and experience the beauty of San Juan,
                Batangas</p>
