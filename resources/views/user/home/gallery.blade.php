    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        galleryItems.forEach(item => {
            item.addEventListener('click', function() {
                ...
                const photoTitle = this.querySelector('h3').textContent;
                const photoDescription = this.querySelector('p').textContent;
                ...
                if (lightboxTitle) lightboxTitle.textContent = photoTitle;
                if (lightboxDescription) lightboxDescription.textContent = photoDescription;
